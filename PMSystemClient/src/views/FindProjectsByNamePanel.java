 ...
 */
public class FindProjectsByNamePanel extends AbstractPanelView {
    ...
    public FindProjectsByNamePanel(String args[]) {
    ...
    public void refresh() {
        ...
        if(!name.equals("")) {
            ProjectData[] result = this.projectsController.getProjects("Name LIKE '%"+name+"%' AND State = 'Active'");
            if(result[0].id == 0) {
                this.jPanel1.setVisible(false);
                this.alertsHelper.showAlert(__("There are no projects with that name"), "information");
            } else {
            ...
            this.alertsHelper.showAlert(__("Please write a name"), "error");
        }
    }
