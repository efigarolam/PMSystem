 ...
 */
public class FindMyProjectsPanel extends AbstractPanelView {
    ...
    public FindMyProjectsPanel(String args[]) {
    ...
    public void configure() {
        ...
        jMenuItem5.setText(__("View Gantt chart"));
    ...
    public void refresh() {
        ProjectData[] result = this.projectsController.getProjects("ID_User = '"+MainController.userOnlineID+"' AND State = 'Active'");
        if(result[0].id == 0) {
