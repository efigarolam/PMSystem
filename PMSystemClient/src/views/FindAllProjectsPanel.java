 ...
 */
public class FindAllProjectsPanel extends AbstractPanelView {
    ...
    public FindAllProjectsPanel(String args[]) {
    ...
    public void refresh() {
        ProjectData[] result = this.projectsController.getProjects("ID > '0' AND State = 'Active'");
        if(result[0].id == 0) {
