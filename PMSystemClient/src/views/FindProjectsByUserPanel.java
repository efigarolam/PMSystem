 ...
 */
public class FindProjectsByUserPanel extends AbstractPanelView {
    ...
    public FindProjectsByUserPanel(String args[]) {
    ...
    public void configure() {
        ...
        jMenuItem5.setText(__("Send message to leader"));
        ...
        jMenuItem6.setText(__("View Gantt chart"));
    ...
    public void refresh() {
        ...
        if(ID_User > 0) {
            ProjectData[] result = this.projectsController.getProjects("ID_User = '"+ID_User+"' AND State = 'Active'");
            if(result[0].id == 0) {
                this.jPanel1.setVisible(false);
                this.alertsHelper.showAlert(__("There are no projects with that user"), "information");
            } else {
            ...
            this.alertsHelper.showAlert(__("Please select a user"), "error");
        }
    }
