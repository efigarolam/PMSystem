 ...
 */
public class FindProjectsMainView extends AbstractIFrameView {
    
    private String[] orbdConfig;
    
    /** Creates new form FindUsersMainView */
    public FindProjectsMainView(String args[]) {
        this.orbdConfig = args;
        initComponents();
    }
    
    public void translate() {
        jLabel2.setText(__("Find Projects"));
        jLabel14.setText(__("Return to home"));
    }
    
    public void configure() {
        this.translate();
        
        FindAllProjectsPanel findAllTab = new FindAllProjectsPanel(this.orbdConfig);
        findAllTab.configure();
        jTabbedPane1.addTab(__("All"), findAllTab);
        FindProjectsByNamePanel findByNameTab = new FindProjectsByNamePanel(this.orbdConfig);
        findByNameTab.configure();
        jTabbedPane1.addTab(__("By Name"), findByNameTab);
        FindProjectsByUserPanel findByUserTab = new FindProjectsByUserPanel(this.orbdConfig);
        findByUserTab.configure();
        jTabbedPane1.addTab(__("By User"), findByUserTab);
        FindProjectsByStatePanel findByStateTab = new FindProjectsByStatePanel(this.orbdConfig);
        findByStateTab.configure();
        jTabbedPane1.addTab(__("By State (Trash)"), findByStateTab);
        FindMyProjectsPanel findMyProjectsTab = new FindMyProjectsPanel(this.orbdConfig);
        findMyProjectsTab.configure();
        jTabbedPane1.addTab(__("My Projects"), findMyProjectsTab);
    }
