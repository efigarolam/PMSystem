 ...
 */
public class FindTasksByPriorityPanel extends AbstractPanelView {
    ...
    public FindTasksByPriorityPanel(String args[]) {
    ...
    public void refresh() {
        Object priority = jComboBox1.getSelectedItem();
        if(!priority.toString().equals("")) {
            TaskData[] result = this.tasksController.getTasks("Priority = '"+priority.toString()+"' AND State != 'Inactive'");
            if(result[0].id == 0) {
                this.jPanel1.setVisible(false);
                this.alertsHelper.showAlert(__("There are no projects with that priority"), "information");
            } else {
            ...
            this.alertsHelper.showAlert(__("Please select a priority"), "error");
        }        
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Urgent", "High", "Medium", "Low" }));
