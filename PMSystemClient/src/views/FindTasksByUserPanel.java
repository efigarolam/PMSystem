 ...
 */
public class FindTasksByUserPanel extends AbstractPanelView {
    ...
    public FindTasksByUserPanel(String args[]) {
    ...
    public void refresh() {
        ...
        if(ID_User > 0) {
            TaskData[] result = this.tasksController.getTasksByUser(ID_User);
            ...
            if(isEmpty) {
                ...
                this.alertsHelper.showAlert(__("There are no tasks for that user"), "information");
            } else {
