 ...
 */
public class FindAllTasksPanel extends AbstractPanelView {
    ...
    public FindAllTasksPanel(String args[]) {
    ...
    public void refresh() {
        TaskData[] result = this.tasksController.getTasks("ID > '0' AND State != 'Inactive'");
        if(result[0].id == 0) {
