 ...
 */
public class FindOutboxMessagesPanel extends AbstractPanelView {
    ...
    public FindOutboxMessagesPanel(String args[]) {
    ...
    private void refresh() {
        MessageData[] result = this.messagesController.getOutboxMessages(MainController.userOnlineID);
        if(result[0].id == 0) {
            ...
            message[0] = __("You don't have outbox messages");
            ...
            for(int i = 0; i < result.length; i++) {
                ...
                row[5] = Integer.toString(result[i].id_receiver);
                row[6] = result[i].date;
