 ...
 */
public class FindAllUsersPanel extends AbstractPanelView {
    ...
    public FindAllUsersPanel(String args[]) {
    ...
    public void refresh() {
        UserData[] result = this.usersController.getUsers("ID > '0' AND State = 'Active'");
        if(result[0].id == 0) {
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Verdana", 0, 17));
        ...
        jButton2.setFont(new java.awt.Font("Verdana", 0, 17));
        ...
        jButton3.setFont(new java.awt.Font("Verdana", 0, 17));
        ...
        jButton4.setFont(new java.awt.Font("Verdana", 0, 17));
